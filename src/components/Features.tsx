            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className={`bento-card flex flex-col justify-between min-h-[300px] ${feature.className}`}
                        >
                            <div>
                                ...
                                <p className="text-zinc-500 leading-relaxed max-w-md">{feature.description}</p>
                            </div>
                            <div className="mt-8">
